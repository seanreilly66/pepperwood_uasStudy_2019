...
# Description:
#
# Generates violin plot of uas and als height kernel density by forest vegetation
...
decid_uas <-
  'data/pntcld_vertical_density/ppwd_uas_height_deciduous_unburned-forest-stand.csv'
decid_als <-
  'data/pntcld_vertical_density/ppwd_als_height_deciduous_unburned-forest-stand.csv'

evrgrn_uas <-
  'data/pntcld_vertical_density/ppwd_uas_height_evergreen_unburned-forest-stand.csv'
evrgrn_als <-
  'data/pntcld_vertical_density/ppwd_als_height_evergreen_unburned-forest-stand.csv'

conifer_uas <-
  'data/pntcld_vertical_density/ppwd_uas_height_conifer_unburned-forest-stand.csv'
conifer_als <-
  'data/pntcld_vertical_density/ppwd_als_height_conifer_unburned-forest-stand.csv'
...
fig <- ggplot(data = height_df,
              mapping = aes(x = veg_class,
                            y = Z,
                            fill = data_type)) +
