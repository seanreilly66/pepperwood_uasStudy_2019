...
write.csv(decid_uas$Z, 'data/pntcld_vertical_density/ppwd_uas_height_deciduous_unburned-forest-stand.csv')
write.csv(decid_als$Z, 'data/pntcld_vertical_density/ppwd_als_height_deciduous_unburned-forest-stand.csv')

write.csv(evrgrn_uas$Z, 'data/pntcld_vertical_density/ppwd_uas_height_evergreen_unburned-forest-stand.csv')
write.csv(evrgrn_als$Z, 'data/pntcld_vertical_density/ppwd_als_height_evergreen_unburned-forest-stand.csv')

write.csv(conifer_uas$Z, 'data/pntcld_vertical_density/ppwd_uas_height_conifer_unburned-forest-stand.csv')
write.csv(conifer_als$Z, 'data/pntcld_vertical_density/ppwd_als_height_conifer_unburned-forest-stand.csv')
