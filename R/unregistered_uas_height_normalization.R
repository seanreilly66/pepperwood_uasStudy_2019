...
# 
# hnorm_las_output <- 'data/las/uas/ppwd_uas_z{z}_f2_noicp_hnorm-dtm.las'
...
foreach (z = zone) %dopar% {
  ...
  # --------------- Isolate ground points and merge with ALS DTM --------------- 
...
# ==============================================================================
# ====================== Generate ground points data set ======================= 
# ==============================================================================

registerDoParallel(11)

foreach (z = zone, .combine = 'rbind') %dopar% {
...
ggsave(filename = 'figures/no_icp_regression2.png', 
       plot = fig,
